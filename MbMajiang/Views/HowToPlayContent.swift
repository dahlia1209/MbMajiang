...
enum HowToPlayContent {
    static let chapters: [HowToPlayChapter] = [
        ...
        HowToPlayChapter(title: "補足4：テンパイの例", blocks: [
            ...
            .tiles(["m1","m2","m3","p4","p5","p6","s7","s8","z1","z1","z1","z2","z2"],
                   caption: "▲テンパイの例①：3面子1雀頭1塔子の形のテンパイ"),
            .paragraph("上記手牌は萬子の123で1面子、筒子の456で１面子、字牌の東3枚で１面子、字牌の南2枚で１雀頭で3面子1雀頭+索子の78（塔子）の形のテンパイです。このテンパイに索子の6または9があると索子78と組み合わせて1面子が完成し、4面子1雀頭が完成します。"),
            .paragraph("索子78のようにあと1枚で面子が完成する2枚の組み合わせを塔子（ターツ）といいます。塔子（ターツ）にはいくつか種類があり、索子78は索子6か9の両方受け入れることができるので両面塔子（リャンメンターツ）といいます。そのほかの塔子（ターツ）の種類として、12の組み合わせは3しか受入できないので辺張塔子（ペンチャンターツ）、24の組み合わせは嵌張塔子（カンチャンターツ）といいます。または同じ牌2枚の組み合わせは対子（トイツ）と呼ばれ、もう1枚同じ牌が来ると刻子が完成するので塔子（ターツ）としても考えることができます。"),
            .paragraph("もう一つ次の「テンパイ」の例を確認しましょう"),
            .tiles(["m1","m2","m3","p4","p5","p6","s7","s8","s9","z1","z1","z1","z2"],
                   caption: "▲テンパイの例②：4面子0雀頭+1枚（単騎）の形のテンパイ"),
            .paragraph("上記手牌は萬子の123で1面子、筒子の456で１面子、索子の789で1面子、字牌の東3枚で 1面子で4面子0雀頭+字牌の南の形のテンパイです。このテンパイでは字牌の南が加わると4面子1雀頭が完成します。雀頭ができると4面子1雀頭が完成する形を単騎待ちといいます。"),
            .paragraph("まとめるとテンパイは手牌13枚に1枚を加えて4面子1雀頭が完成する時の手牌13枚の形です。テンパイには3面子1雀頭1塔子または4面子0雀頭の単騎待ちの2種類があります。"),
        ]),
